...
[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=17480808)
...
2. **Scene Composition:**
   ...
   - Determine the last alphabet character of your name. For example, if your name is "AINUN", the last alphabet is "N".
   - Determine the last digit of your student ID. For example, if your student ID is `5025221053`, the last digit is `3`.
...
3. **Color Specification:**
   ...
   - Assign the alphabet mesh your favorite color from Assignment 1 (#87ceeb).
   - Assign the digit mesh the complementary color of the alphabet’s color (#fc976c).
